            ...
            for index in range(len(request.POST.getlist('schedule_name[]'))):
                ...
                if schedule_id == 0:
                    ...
                    if schedule:
                        ...
                        schedule.instructions=request.POST.getlist('schedule_instructions[]')[index]
                        schedule.venue_name=request.POST.getlist('schedule_venue_name[]')[index]
                        schedule.venue_address=request.POST.getlist('schedule_venue_address[]')[index]
                        schedule.venue_map_link=request.POST.getlist('schedule_venue_map[]')[index]
                        schedule.save()
