...
urlpatterns = [
    ...
    path(
        "<group_id>/edit-member/<member_id>",
        views.edit_group_member,
        name="edit_group_member",
    ),
    path(
        "<group_id>/remove-member/<member_id>",
    ...
    path(
        "<group_id>/message/<message_id>", views.message_details, name="message_details"
    ),
    path("<group_id>/conversation/", views.conversations, name="conversations"),
    path(
        "<group_id>/conversation/<message_id>",
        views.conversation_details,
